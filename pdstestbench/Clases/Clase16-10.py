# -*- coding: utf-8 -*-
"""
Created on Thu Oct 16 19:39:26 2025
...
w, h = signal.freqs(b, a, worN=np.logspace(-1, 2, 1000))  # 10 Hz a 1 MHz aprox. Espaciamiento lineal en coeficientes (eje logarítmico de 10^1 a 10^6 con 1000 puntos)
